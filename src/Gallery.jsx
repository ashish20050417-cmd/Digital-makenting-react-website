    ...
    <div className="min-h-screen bg-[#f8f9fc]">
      ...
      <section className="max-w-[1450px] mx-auto px-8 pt-16 pb-10 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-10">
          <button className="px-7 py-3 rounded-full bg-blue-600 text-white font-semibold shadow">
            All Projects
          </button>

          <button className="px-7 py-3 rounded-full border border-gray-300 bg-white hover:bg-blue-50">
            Simple Websites
          </button>
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-500">
                High-end, visually stunning websites with cinematic experience.
              </p>
            </div>
          </div>
